...
_**INIZIALIZZAZIONE PROCESSI UNIX**_ 
1. Init fa una fork() sul programma _getty_
2. getty controlla l'accesso al sistema e con una exec genera il login 
3. in caso di accesso corretto, login esegue lo _shell_ con una exec() ([[interazione con shell]])